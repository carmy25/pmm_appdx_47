    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('responsible_person', models.CharField(max_length=233, verbose_name='відповідальна особа')),
                ('receiver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invoices_receiver', to='departments.department', verbose_name='отримувач')),
                ('sender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invoices_sender', to='departments.department', verbose_name='відправник')),
            ],
            options={
